...
<body>
<?php
if(isset($_SESSION["zalogowany"])){$message = "Masz już konto. Przekierowanie nastąpi po 1 sec";
...
<div class="wrapper">
	...
	<form class="form" method="POST" action="skrypt(1).php">
	
   <a>Nazwa Użytkownika</a><br>
       <input type="text" name="login" required><br>
		 <a>Hasło</a><br>
		<input type="password" name="haslo" placeholder="min.6 znaków" minlength="6" required ><br>
		<a>Email</a><br>
		 <input type="email" name="email" placeholder="przykład@gmail.com" required><br>
<input type="submit" value="Utwórz konto" name="rejestracja">
</form>
