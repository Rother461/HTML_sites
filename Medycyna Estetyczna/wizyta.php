...
<body>
<?php
if(!isset($_SESSION["zalogowany"])){echo "nie masz dostępu do tej części witryny. <a href='logowanie.php'>Zaloguj się</a>"; exit();}
?>
	   <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<?php
						   ...
						   {
					'<li class="nav-item">';
						 echo '<a class="nav-link" href="#">'.$_SESSION['login'].'</a>';
					'</li>';
					'<li class="nav-item">';
						 echo '<a class="nav-link" href="wizyta.php">Umów wizytę</a>';
					'</li>';
...
<form class="form"method="POST" action="wizytaskrypt.php">
   ...
   <a>Imię</a><br>
	...
	<a>Pesel</a><br>
<input name="pesel" type="number" size="11" required ><br>
<a>Telefon</a><br>
<input name="telefon" type="number" size="9"  required><br>
<div class="lewo">
<a>Data</a><br>
<input type="date"step=7 min=2020-06-02 name="data"required>
</div>
<div class="prawo">
<a>Godzina</a><br>
<input type="time" name="czas"list="godzina">
<datalist id="godzina">
<option value="15:00">
    <option value="16:00">
    <option value="17:00">
...
<input type="submit" value="Umów wizytę" name="wizyta">
</form>
<style type="text/css">
...
echo '<p class="zajete">Zajęte terminy:</p>';
echo "<table class='table table-dark' cellpadding=\"2\" border=1>";
if (mysqli_num_rows($result) >= 0) {
	echo "<tr>";
       
			echo "<td><b>Data</td>";
			echo "<td><b>Godzina</td>";
        echo "</tr>";
