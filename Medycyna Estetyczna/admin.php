...
<body>
<?php
if(!isset($_SESSION["admin"])){echo "nie masz dostępu do tej części witryny. <a href='logowanie.php'>Zaloguj się</a>"; exit();}
?>
	   <div class="wrapper">
...
<form action="usun.php" class="usun" method="post">
	  <input type="text" name="usun_rekord" value="">
