   ...
   <div class="sidebar-header">
	...
	{ echo'<li class="nav-item">
		...
		echo'<li class="nav-item">
			...
			<div class="full">
<div class="cennikl">
<a target="_blank" href="skany/cennik1.jpg">
    <img src="skany/cennik1.jpg" alt="Cennik" width="600" height="400">
  </a>
</div>
<div class="cennikl">
<a target="_blank" href="skany/cennik2.jpg">
    <img src="skany/cennik2.jpg" alt="Cennik" width="600" height="400">
  </a>
</div>
        </div>  
        </div>
